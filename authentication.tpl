...
*}
{capture name=path}
	{if !isset($email_create)}{l s='Login Or Register'}{else}
		<a href="{$link->getPageLink('authentication', true)|escape:'html':'UTF-8'}" rel="nofollow" title="{l s='Login Or Register'}">{l s='Login Or Register'}</a>
		<span class="navigation-pipe">{$navigationPipe}</span>{l s='Create your account'}
	{/if}
{/capture}
<h1 class="page-heading hidden">{if !isset($email_create)}{l s='Login Or Register'}{else}{l s='Create an account'}{/if}</h1>
...
{if !isset($email_create)}
	<div class="row">
		<div class="col-xs-12 col-sm-6">
			<form action="{$link->getPageLink('authentication', true)|escape:'html':'UTF-8'}" method="post" class="log-reg-form" id="login_form_cus">
				<h3 class="page-subheading form-title">{l s='Login'}</h3>
				<div class="form_content clearfix">
					<div class="form-header-login clearfix">
						<p>{l s='Hello, Welcome to your account'}</p>
					</div>
					...
					<div class="form-group clearfix">
						...
						<input class="is_required validate account_input form-control" type="password" data-validate="isPasswd" id="passwd-cus" name="passwd" value="" />
					</div>
					<div class="form-group form-group-char clearfix">
						<p><input type="checkbox" name="user-remember"> {l s='Remember me!'}</p>
						<p class="lost_password"><a href="{$link->getPageLink('password')|escape:'html':'UTF-8'}" title="{l s='Recover your forgotten password'}" rel="nofollow">{l s='Forgot your password?'}</a></p>
					</div>
					<p class="submit clearfix">
						{if isset($back)}<input type="hidden" class="hidden" name="back" value="{$back|escape:'html':'UTF-8'}" />{/if}
						<button type="submit" id="SubmitLogin" name="SubmitLogin" class="button btn btn-default button-medium dor-effect-hzt">
							<span>
								{l s='Login'}
							</span>
						</button>
		...
		<div class="col-xs-12 col-sm-6">
			<form action="{$link->getPageLink('authentication', true)|escape:'html':'UTF-8'}" method="post" class="log-reg-form" id="create-account_form">
				<h3 class="page-subheading form-title">{l s='Create a new account'}</h3>
				<div class="form_content clearfix">
					<p>{l s='Create your own Unicase account'}</p>
					<div class="alert alert-danger" id="create_account_error" style="display:none"></div>
					<div class="form-group">
						<label for="email_create">{l s='Email address'}<sup>*</sup></label>
					...
					<div class="submit">
						{if isset($back)}<input type="hidden" class="hidden" name="back" value="{$back|escape:'html':'UTF-8'}" />{/if}
						<button class="btn btn-default button button-medium exclusive dor-effect-hzt" type="submit" id="SubmitCreate" name="SubmitCreate">
							<span>
								{l s='Sign up'}
							</span>
						</button>
					...
					<div class="registration-info">
                        <h5>{l s='SignUp today and you\'ll be able to:'}</h5>
                        <ul>
                            <li>{l s='Speed your way through the checkout.'}</li>
                            <li>{l s='Track your orders easily.'}</li>
                            <li>{l s='Keep a record of all your purchases.'}</li>
                        </ul>
                    </div>
				</div>
			</form>
				...
				<div id="opc_account_form" style="display: block; ">
					...
					<div id="opc_invoice_address"  class="unvisible">
						...
						<div class="required id_state_invoice form-group" style="display:none;">
							...
							<select name="id_state_invoice" id="id_state_invoice" class="selectpicker">
								<option value="">-</option>
							</select>
						</div>
						{/if}
	...
	{/if}
{else}
	<div class="col-xs-12 col-sm-6 col-lg-6 auth-info-user">
		<form action="{$link->getPageLink('authentication', true)|escape:'html':'UTF-8'}" method="post" id="account-creation_form" class="std box log-reg-form">
			{$HOOK_CREATE_ACCOUNT_TOP}
			<div class="account_creation">
				<h3 class="page-subheading form-title">{l s='Your personal information'}</h3>
			...
			<div class="submit clearfix">
				...
				<p class="pull-right required hidden"><span><sup>*</sup>{l s='Required field'}</span></p>
			</div>
		</form>
	</div>
	<div class="col-xs-12 col-sm-6 col-lg-6 auth-info-user">
			...
			<div class="form_content clearfix">
				<div class="form-header-login clearfix">
					...
					<div class="social-login">
                        <a href="#" class="facebook-login"><i class="fa fa-facebook"></i>{l s='Sign In With Facebook'}</a>
                        <a href="#" class="twitter-login"><i class="fa fa-twitter"></i>{l s='Sign In With Twitter'}</a>
                    </div>
				</div>
				<div class="form-group clearfix">
					<label for="email">{l s='Email address'}<sup>*</sup></label>
