...
<div id="dor_search_top" class="center_column col-lg-12 col-md-12 col-xs-12 col-sm-12 clearfix" >
    <form method="get" action="{$link->getPageLink('search')|escape:'html'}" id="searchbox" class="form-inline">
        ...
        <div class="dor_search form-group col-lg-8 col-md-8 col-xs-8 col-sm-8">
			...
			<input class="search_query form-control" type="text" id="dor_query_top" name="search_query" value="{$search_query|escape:'html':'UTF-8'|stripslashes}" placeholder="{l s='What are you looking for?' mod='dor_searchcategories'}" autocomplete="off" />
        </div>
