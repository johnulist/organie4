...
<div id="dor-tabsidebar-product-category">
	<div class="dor-tabsidebar-product-category-wrapper">
		<ul role="tablist" class="nav nav-tabs dorTabAjaxSidebar" id="dorTabAjaxSidebar" data-ajaxurl="{$base_dir}modules/dor_ajaxtabsidebar_product/productcategory-ajax.php">
			{$j=0}
