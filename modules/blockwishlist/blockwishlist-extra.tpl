...
{else}
	{foreach name=wl from=$wishlists item=wishlist}
		...
		{/if}
	{foreachelse}
		<a href="#" id="wishlist_button_nopop" class="button--sacnite button--round-l" onclick="WishlistCart('wishlist_block_list', 'add', '{$id_product|intval}', $('#idCombination').val(), document.getElementById('quantity_wanted').value); return false;" rel="nofollow"  title="{l s='Add to wishlist' mod='blockwishlist'}" data-toggle="tooltip" data-placement="top">
			<span class="hidden">{l s='Add to wishlist' mod='blockwishlist'}</span>
		</a>
	{/foreach}
{/if}
