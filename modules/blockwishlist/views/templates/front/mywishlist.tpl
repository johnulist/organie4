...
<div id="mywishlist">
	...
	<h1 class="page-heading hidden">{l s='My wishlists' mod='blockwishlist'}</h1>

	{include file="$tpl_dir./errors.tpl"}

	{if $id_customer|intval neq 0}
		<form method="post" class="std box hidden" id="form_wishlist">
			<fieldset>
				...
				<table class="table table-bordered">
					<thead>
						<tr>
							...
							<th class="item mywishlist_second hidden">{l s='Direct Link' mod='blockwishlist'}</th>
					...
					<tbody>
						{section name=i loop=$wishlists}
							<tr id="wishlist_{$wishlists[i].id_wishlist|intval}">
								...
								<td class="hidden">
									<a href="#" onclick="javascript:event.preventDefault();WishlistVisibility('wlp_bought_infos', 'BoughtProductsInfos'); return false;">
