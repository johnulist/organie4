	...
	<div class="about-group-steps">
		<div class="step-cols step-left col-lg-4 col-md-4 col-sm-12 col-xs-12">
			<div class="step-signle">
				<span class="icon-step"><img src="{$base_dir}img/cms/dorado/aboutus/icon/icon-step-1.png" alt=""></span>
			...
			<div class="step-signle">
				<span class="icon-step"><img src="{$base_dir}img/cms/dorado/aboutus/icon/icon-step-3.png" alt=""></span>
				<div class="step-sign-info">
			...
			<div class="step-signle">
				<span class="icon-step"><img src="{$base_dir}img/cms/dorado/aboutus/icon/icon-step-5.png" alt=""></span>
				<div class="step-sign-info">
		...
		<div class="step-cols step-middle col-lg-4 col-md-4 col-sm-12 col-xs-12">
			<div class="step-col-middle">
				<img src="{$base_dir}img/cms/dorado/aboutus/icon/main-step.png" alt="">
			</div>
		</div>
		<div class="step-cols step-right col-lg-4 col-md-4 col-sm-12 col-xs-12">
			<div class="step-signle">
				<span class="icon-step"><img src="{$base_dir}img/cms/dorado/aboutus/icon/icon-step-2.png" alt=""></span>
				<div class="step-sign-info">
			...
			<div class="step-signle">
				<span class="icon-step"><img src="{$base_dir}img/cms/dorado/aboutus/icon/icon-step-4.png" alt=""></span>
				<div class="step-sign-info">
			...
			<div class="step-signle">
				<span class="icon-step"><img src="{$base_dir}img/cms/dorado/aboutus/icon/icon-step-6.png" alt=""></span>
				<div class="step-sign-info">
