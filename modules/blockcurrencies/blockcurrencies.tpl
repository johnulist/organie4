...
<div class="dorCurrenciesBlock">
	<h3><span class="txt-code-label">{l s='Currency' mod='blockcurrencies'}:</span>
	<span class="txt-iso-code">
		...
		<div id="currencies-block-top">
			<form id="setCurrency" action="{$request_uri}" method="post">
				<div class="hidden">
					...
					<span class="cur-label hidden">{l s='Currency' mod='blockcurrencies'} :</span>
				</div>
