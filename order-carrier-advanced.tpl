        ...
        <div id="carrier_area" class="opc-main-block">
            ...
            <div id="opc_delivery_methods" class="opc-main-block">
                ...
                <p class="cart_navigation clearfix">
                    ...
                    {if !$is_guest}
                        {if $back}
                            <a href="{$link->getPageLink('order', true, NULL, "step=1&back={$back}{if $multi_shipping}&multi-shipping={$multi_shipping}{/if}")|escape:'html':'UTF-8'}" title="{l s='Previous'}" class="button-exclusive btn btn-default ContinueShop">
                                <span><i class="icon-chevron-left"></i>
                                {l s='Continue shopping'}</span>
                            </a>
                        {else}
                            <a href="{$link->getPageLink('order', true, NULL, "step=1{if $multi_shipping}&multi-shipping={$multi_shipping}{/if}")|escape:'html':'UTF-8'}" title="{l s='Previous'}" class="button-exclusive btn btn-default ContinueShop">
                                <span><i class="icon-chevron-left"></i>
                                {l s='Continue shopping'}</span>
                            </a>
                        {/if}
                    {else}
                        <a href="{$link->getPageLink('order', true, NULL, "{if $multi_shipping}multi-shipping={$multi_shipping}{/if}")|escape:'html':'UTF-8'}" title="{l s='Previous'}" class="button-exclusive btn btn-default ContinueShop">
                            <span><i class="icon-chevron-left"></i>
                            {l s='Continue shopping'}</span>
                        </a>
                    {/if}
