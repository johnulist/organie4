...
function accordionFooter(status)
{
	if(status == 'enable')
	{
		$('#footer .footer-block h4').on('click', function(e){
                  $('#footer .toggle-footer').hide(800);
                  if($(this).hasClass('active') === false)
                  {
                    /* Si on demande a développer une nouvelle catégorie */
                    $('#footer .footer-block h4').removeClass('active');
                    $(this).siblings('.toggle-footer').toggle(800);
		    e.preventDefault();
                  }
