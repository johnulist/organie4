...
{if !$opc}
	...
	<h1 class="page-heading hidden">{l s='Addresses'}</h1>
	{include file="$tpl_dir./order-steps.tpl"}
	{include file="$tpl_dir./errors.tpl"}
		<form action="{$link->getPageLink($back_order_page, true)|escape:'html':'UTF-8'}" method="post">
{else}
	{assign var="back_order_page" value="order-opc.php"}
	<h1 class="page-heading step-num hidden"><span>1</span> {l s='Addresses'}</h1>
	...
	<div class="row">
		<div class="col-xs-12 col-sm-6">
			<div class="address_delivery select form-group selector1">
				...
				<select name="id_address_delivery" id="id_address_delivery" class="address_select selectpicker">
...
{if !$opc}
			<p class="cart_navigation clearfix">
				...
				<a href="https://www.mon-savonnier.fr" title="{l s='Previous'}" style="display: block; text-align: center">
